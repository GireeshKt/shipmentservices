...
/**
 * The ExcelShipmentSuccessRowsResponse is used to handle the response of valid Excel for PO Upload Operation
 *
 */
public class ExcelPurchaseOrderSuccessRowsResponse implements Serializable{
	...
	public ExcelPurchaseOrderSuccessRowsResponse() {
